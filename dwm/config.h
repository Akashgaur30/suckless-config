...
static char *fonts[] = {"Ubuntu mono:size=14:antialias=true:autohint=true", "monospace:size=11", "JoyPixels:pixelsize=11:antialias=true:autohint=true"};
...
#include "/home/akash/.cache/wal/colors-wal-dwm.h"
...
static Key keys[] = {
	...
	{MODKEY | ShiftMask, XK_b, spawn, SHCMD("ls -t ~/pix/wall/* | sxiv -tio")},
	...
	/*{MODKEY, XK_F1, spawn, SHCMD("groff -mom /usr/local/share/dwm/parbs.mom -Tpdf | zathura -")},*/
	{MODKEY, XK_F1, spawn, SHCMD("bugwall")},
	{MODKEY, XK_F2, spawn, SHCMD("tutorialvids")},
	{MODKEY, XK_F3, spawn, SHCMD("displayselect")},
	{MODKEY, XK_F4, spawn, SHCMD(TERMINAL " -e pulsemixer; kill -44 $(pidof dwmblocks)")},
	/*{MODKEY, XK_F5, xrdb, {.v = NULL}},*/
	{MODKEY, XK_F5, spawn, SHCMD("sudo brillo -q -U 10")},
/*	{MODKEY, XK_F6, spawn, SHCMD("torwrap")},*/
	{MODKEY, XK_F6, spawn, SHCMD("sudo brillo -q -A 10")},
